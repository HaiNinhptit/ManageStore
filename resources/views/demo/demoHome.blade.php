            ...
            <ul class="list-group margin-bottom-25 sidebar-menu">
              ...
              <li class="list-group-item clearfix dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="list-group-item dropdown clearfix">
                    <a href="shop-product-list.html"><i class="fa fa-angle-right"></i> Athletic Shoes </a>
                  </li>
                  <li class="list-group-item dropdown clearfix">
                    <a href="shop-product-list.html"><i class="fa fa-angle-right"></i> High Heels </a>
                  </li>
                  <li><a href="shop-product-list.html"><i class="fa fa-angle-right"></i> Flat Shoes</a></li>
                </ul>
              </li>
              ...
              <li class="list-group-item clearfix dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="shop-product-list.html"><i class="fa fa-angle-right"></i> Leather Shoes</a></li>
                </ul>
              </li>
