...
<body class="ecommerce">
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                        @if(Session::has('user_id'))
                          <li><a href="{{action('UserController@edit')}}">Wellcome {{Session::get('name')}}</a></li>
                          <li><a href="{{action('GuestController@showCart')}}">Checkout</a></li>
    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href="{{action('UserController@index')}}"><img src="{{asset('assets/corporate/img/logos/logo-shop-red.png')}}" alt="Metronic Shop UI"></a>
        ...
        <div class="top-cart-block">
          <div class="top-cart-info">
            @if (Session::has('user_id') && isset($cart))
              <a href="javascript:void(0);" class="top-cart-info-count">{{$cart->countItem()}} items</a>
                ...
                @if (Session::has('user_id') && isset($cart))
                  <ul class="scroller" style="height: 250px;">
                    @foreach ($cart->cartProducts as $cartProduct)
                      <li>
                        <a href="#"><img src="{{URL::asset('/images/products/'. $cartProduct->product->pictures->first()['name'])}}" alt="{{$cartProduct->product->pictures->first()['name']}}" width="37" height="34"></a>
                        <span class="cart-content-count">x {{$cartProduct->quantity}}</span>
                        <strong><a href="shop-item.html">{{$cartProduct->product->name}}</a></strong>
                        <em>${{$cartProduct->product->price}}</em>
                        <a href="javascript:void(0);" class="del-goods">&nbsp;</a>
                      </li>
                    @endforeach  
                  </ul>
                  <div class="text-right">
                    <a href="{{action('CartController@index')}}" class="btn btn-default">View Cart</a>
                    <a href="{{action('GuestController@showCart')}}" class="btn btn-primary">Checkout</a>
                  </div>   
                @elseif (Session::has('products'))
                  <ul class="scroller" style="height: 250px;">
                    @for ($i = 0; $i < count($productCart); $i++)
                    <li>
                    <a href="#"><img src="{{URL::asset('/images/products/'. $productCart[$i]->pictures->first()['name'])}}" alt="{{$productCart[$i]->pictures->first()['name']}}" width="37" height="34"></a>
                        <span class="cart-content-count">x {{$products[$i]['number']}}</span>
                        <strong><a href="shop-item.html">{{$productCart[$i]->name}}</a></strong>
        ...
        <div class="header-navigation">
          <ul>
          <li class="dropdown">
              <a class="dropdown-toggle" href="{{action('UserController@index')}}">
                Home
            ...
            @foreach ($categoryByTrademarks as $categoryByTrademark)
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  @foreach ($categoryByTrademark as $category)
                  <li><a href="{{action('ProductController@searchByCategory',['category_id'=> $category['id']])}}">{{$category['name']}}</a></li>
                  @endforeach
                </ul>
                <!-- END DROPDOWN MENU -->
              </li> 
    ...
    @yield('content')
      ...
      <div class="container">
            <div class="owl-carousel owl-carousel6-brands">
              <a href="#"><img src="{{asset('assets/pages/img/brands/canon.jpg')}}" alt="canon" title="canon"></a>
              <a href="#"><img src="{{asset('assets/pages/img/brands/esprit.jpg')}}" alt="esprit" title="esprit"></a>
              <a href="#"><img src="{{asset('assets/pages/img/brands/gap.jpg')}}" alt="gap" title="gap"></a>
              <a href="#"><img src="{{asset('assets/pages/img/brands/next.jpg')}}" alt="next" title="next"></a>
              <a href="#"><img src="{{asset('assets/pages/img/brands/puma.jpg')}}" alt="puma" title="puma"></a>
              <a href="#"><img src="{{asset('assets/pages/img/brands/zara.jpg')}}" alt="zara" title="zara"></a>
              <a href="#"><img src="{{asset('assets/pages/img/brands/canon.jpg')}}" alt="canon" title="canon"></a>
              <a href="#"><img src="{{asset('assets/pages/img/brands/esprit.jpg')}}" alt="esprit" title="esprit"></a>
              <a href="#"><img src="{{asset('assets/pages/img/brands/gap.jpg')}}" alt="gap" title="gap"></a>
              <a href="#"><img src="{{asset('assets/pages/img/brands/next.jpg')}}" alt="next" title="next"></a>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 pre-footer-col">
            ...
            <a class="twitter-timeline" href="#" data-tweet-limit="2" data-theme="dark" data-link-color="#57C8EB" data-widget-id="455411516829736961" data-chrome="noheader nofooter noscrollbar noborders transparent">Loading tweets by @keenthemes...</a>      
          </div>
          <!-- END TWITTER BLOCK -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4 text-right">
            <p class="powered">Powered by: <a href="#">KeenThemes.com</a></p>
          </div>
          <!-- END POWERED -->
        </div>
      </div>
