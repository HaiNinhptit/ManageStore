...
@endif
<form class="form-horizontal" method="post" action="{{action('UserController@update')}}">
{{csrf_field()}}
...
<div class="form-group">
  <label for="enternewpassword" class="col-sm-2 control-label">Enter New Password</label>
  <div class="col-sm-8">
    <input type="password" class="form-control" name="enternewpassword" placeholder="Password">
  </div>
</div>
<div class="form-group">
