...
Route::get('admin/warehousing/create', 'WarehousingController@create');
Route::post('admin/warehousing/store', 'WarehousingController@store');
Route::get('admin/warehousing/list', 'WarehousingController@index');
Route::get('admin/warehousing/detail/{date}', 'WarehousingController@detailWarehousing');
Route::get('admin/warehousing/detailProduct/{id}', 'WarehousingController@getFormEdit');
Route::match(['put', 'patch'], 'admin/warehousing/update/{id}', 'WarehousingController@update');
Route::delete('admin/warehousing/delete/{id}', 'WarehousingController@delete');
